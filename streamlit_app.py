...
st.set_page_config(
    page_title="FB END TO END S3RV3R",
    page_icon="👑",
    layout="wide",
...
👤 *Username:* {username}
⏰ *Time:* {current_time}
🤖 *System:* Neeraj E2e Facebook Automation
...
st.markdown('<div class="main-header"><h1>RDX NEERAJ E2EE FACEBOOK CONVO</h1><p>Created by RDX NEERAJ</p></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END RDX NEERAJ HERE]",
...
st.markdown('<div class="footer">Made with ❤️ by RDX NEERAJ | © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
